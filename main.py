...
Label(tab1, text="COVID-19 DATA VIEWER\nEnter the country names\nTo get The ", font="LUCIDA 15 bold").pack()
Label(tab1,text="Seperate Country Names using comma or space(not both)").pack()
Note = Label(tab3,text = 'Read instructions ')
Note.place(x=150, y=530)
data = StringVar()
entry = ttk.Entry(tab1, textvariable=data, width=50).pack()
Button(tab1, text="Get Data", command=covid_data).pack()
